"""Fixtures and test doubles shared across baton's test suite.

A test module cannot import another test module, so every double a second
module needs lives here and reaches a test as a fixture. A plain fixture
hands over the default double; a `make_` fixture hands over the class or a
